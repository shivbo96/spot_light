...
class RopeLightAnimation extends StatefulWidget {
  const RopeLightAnimation({Key? key}) : super(key: key);

  @override
  State<RopeLightAnimation> createState() => _RopeLightAnimationState();
}

class _RopeLightAnimationState extends State<RopeLightAnimation>
  ...
  Widget build(BuildContext context) {
    final decoration = isOn
        ? BoxDecoration(
            ...
            image: const DecorationImage(image: AssetImage('assets/on.png')))
        : const BoxDecoration(
            image: DecorationImage(image: AssetImage('assets/on.png')));
...
class RopePainter extends CustomPainter {
  ...
  RopePainter({required this.isOn,this.springOffset = const Offset(0, 0)});

  @override
  void paint(Canvas canvas, Size size) {
    final center = size.topCenter(Offset.zero);
    final Paint springPaint = Paint()
      ..color = isOn?Colors.yellowAccent.shade200:Colors.black12
      ..strokeWidth = 4.0
